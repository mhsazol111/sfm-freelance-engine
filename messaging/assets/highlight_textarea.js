...
(function($) {
    ...
    HighlightWithinTextarea.prototype = {
        ...
        renderMarks: function(boundaries) {
            ...
            var popNotification = '<div class="la_msg_reply_notification"><i class="la_close_pop_notification fa fa-close"></i><p><strong>' +
                'Considering to communicate or pay outside of Link-able?</strong></p>' +
                '<p>' +la_pm.popupMessage+'</p></div>';
            input = input.replace(/\{\{hwt-mark-stop\}\}/g, popNotification + '</mark>');
...
jQuery(document).ready(function ($) {
    $('.inquiry_message textarea, #la_reply_msg').highlightWithinTextarea({
        highlight: [
            'paypal',
            'email',
    ...
    $(function() {
        $('.inquiry_message textarea, #la_reply_msg').on('keyup paste', function() {
            var $el = $(this),
    ...
    $('body').on('click', '.la_close_pop_notification', function (e) {
        e.preventDefault();
        $(this).parent().remove();
    })
});