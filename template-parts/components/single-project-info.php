...
<div class="dashboard_title single-project-top-meta-desc">
    <div class="d_t_info">
        ...
        <div class="e_nav">
            ...
            <?php 
            if ( $post->post_status == 'close' || $post->post_status == 'disputing' ) { ?>
            ...
            <?php if( $user_role == FREELANCER ): ?>
                <!-- <div class="project-detail-action"> -->
                    <form action="" method="POST" class="edit-form" enctype="multipart/form-data">
                        <button type="submit" name="submit_auth" class="send_message"><i class="far fa-envelope" aria-hidden="true"></i> Send Message</button>
                    </form>
                <!-- </div> -->
            <?php endif; ?>
