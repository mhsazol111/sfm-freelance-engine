...
<?php } ?>
<hr>
<div class="workspace-meta-descrition dashboard_title">
    <div class="d_t_info">
        <h2 class="project-detail-title"><a href="<?php echo $project_link; ?>"><?php the_title(); ?></a></h2>
        <div class="e_nav">
            <ul class="project-bid-info-list">
                ...
                <li>
                    <span><?php _e( 'Posted on:', ET_DOMAIN ); ?></span>
                    <span><?php echo $project->post_date ?></span>|
                </li>
                <li>
                    <span><?php _e( 'Project Status:', ET_DOMAIN ); ?></span>
