...
<div class="menu">
    <ul>
        ...
        <li class="<?php echo $current_page_url == home_url( 'help-and-support' ) ? 'current-page' : ''; ?>"><a href="/help-and-support/"><i class="fa fa-question-circle"></i><?php _e( 'Help and Support', ET_DOMAIN ) ?></a></li>
